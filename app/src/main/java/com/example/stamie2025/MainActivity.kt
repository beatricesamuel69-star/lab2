...
class MainActivity : AppCompatActivity() {
    ...
    private val resultLauncher = registerForActivityResult(
        ...
        if (result.resultCode == RESULT_OK && data != null) {
            val question = data.getStringExtra("question-key")
            val answer = data.getStringExtra("answer-key")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val stamie2025=findViewById<ImageView>(R.id.imageView4)
        questionText=findViewById<TextView>(R.id.question)
        answerText=findViewById<TextView>(R.id.Text2)
